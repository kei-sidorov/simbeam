...
// fps is the screenshot/encode frame rate for the WebRTC path.
const fps = 15
...
// pipeline. The feed stops when ctx is cancelled; the caller must also Close()
// it to reap the sidecar.
